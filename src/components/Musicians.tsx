...
const musicians = [
  {
    ...
    name: "",
    role: "",
    mainImage: `${IMAGES_DIR}/IMG_0307.jpg`,
    gallery: [`${IMAGES_DIR}/IMG_0307.jpg`],
  ...
  },
  {
    ...
    name: "",
    role: "",
    mainImage: `${IMAGES_DIR}/IMG_0311.jpg`,
    gallery: [`${IMAGES_DIR}/IMG_0311.jpg`],
    videos: ["video-id-1", "video-id-2"],
  },
  {
    id: 3,
    name: "",
    role: "",
    mainImage: `${IMAGES_DIR}/IMG_0309.jpg`,
    gallery: [`${IMAGES_DIR}/IMG_0309.jpg`],
    videos: ["video-id-1", "video-id-2"],
  },
  {
    id: 4,
    name: "",
    role: "",
    mainImage: `${IMAGES_DIR}/IMG_0310.jpg`,
    gallery: [`${IMAGES_DIR}/IMG_0310.jpg`],
    videos: ["video-id-1", "video-id-2"],
  },
  {
    id: 5,
    name: "",
    role: "",
    mainImage: `${IMAGES_DIR}/IMG_0308.jpg`,
    gallery: [`${IMAGES_DIR}/IMG_0308.jpg`],
    videos: ["video-id-1", "video-id-2"],
  },
];
