...
const singers = [
  {
    ...
    mainImage: `${IMAGES_DIR}/jigneshchauhan.jpg`,
    gallery: [
      `${IMAGES_DIR}/jigneshchauhan.jpg`,
      `${IMAGES_DIR}/jigneshchauhan.jpg`,
      `${IMAGES_DIR}/jigneshchauhan.jpg`,
    ],
    videos: ["h89hNIkQVP4", ""],
  },
  {
    ...
    name: "Hardik Soni",
    role: "Singer & Organiser",
    mainImage: `${IMAGES_DIR}/hardiksoni.jpg`,
    gallery: [
      `${IMAGES_DIR}/hardiksoni.jpg`,
      `${IMAGES_DIR}/hardiksoni.jpg`,
      `${IMAGES_DIR}/hardiksoni.jpg`,
    ],
    videos: ["", ""],
  },
  {
    ...
    mainImage: `${IMAGES_DIR}/raajpandit.jpg`,
    gallery: [
      `${IMAGES_DIR}/raajpandit.jpg`,
      `${IMAGES_DIR}/raajpandit.jpg`,
      `${IMAGES_DIR}/raajpandit.jpg`,
    ],
    videos: ["", ""],
