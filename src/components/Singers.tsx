...
const singers = [
  {
    ...
    mainImage: `/public/images/singers/jigneshchauhan.jpg`,
    gallery: [`/public/images/singers/jigneshchauhan.jpg`],
    videos: ["h89hNIkQVP4", ""],
  },
  {
    id: 2,
    name: "Hardik Soni",
    role: "Singer & Organiser",
    mainImage: `/public/images/singers/hardiksoni.jpg`,
    gallery: [`/public/images/singers/hardiksoni.jpg`],
    videos: ["", ""],
  },
  {
    id: 3,
    ...
    mainImage: `/public/images/singers/raajpandit.jpg`,
    gallery: [`/public/images/singers/raajpandit.jpg`],
    videos: ["", ""],
  },
];
