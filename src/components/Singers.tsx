...
const singers = [
  {
    ...
    mainImage: `/images/singers/jigneshchauhan.jpg`,
    gallery: [`/images/singers/jigneshchauhan.jpg`],
    videos: ["h89hNIkQVP4", ""],
  },
  {
    id: 2,
    name: "Hardik Soni",
    role: "Singer & Organiser",
    mainImage: `/images/singers/hardiksoni.jpg`,
    gallery: [`/images/singers/hardiksoni.jpg`],
    videos: ["", ""],
  },
  {
    id: 3,
    ...
    mainImage: `/images/singers/raajpandit.jpg`,
    gallery: [`/images/singers/raajpandit.jpg`],
    videos: ["", ""],
  },
];
